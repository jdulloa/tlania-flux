...
class AuthorizationController extends Controller
{
    ...
    public function authorizeForm()
    {
        ...
        if (!$user->status) {
            ...
            $type = 'sms';
            $pageTitle = __('Verify Mobile Number');
            $notifyTemplate = 'SVER_CODE';
        }elseif (!$user->tv) {
            $pageTitle = __('2FA Verification');
            $type = '2fa';
        }else{
    ...
    public function sendVerifyCode($type)
    {
        ...
        if ($this->checkCodeValidity($user)) {
            ...
            throw ValidationException::withMessages(['resend' => __('Please try after ') . $delay . __(' seconds.')]);
        }
        ...
        $notify[] = ['success', __('Verification code was sent successfully.')];
    ...
    public function emailVerification(Request $request)
    {
        ...
        throw ValidationException::withMessages(['code' => __('Verification code does not match.')]);
    }
