...
class ManageUsersController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $countryCode    = $request->country_code ?? $request->country;
        $countryObj     = isset($countryData[$countryCode]) ? $countryData[$countryCode] : null;
        $countryName    = $countryObj->country ?? $request->country_name ?? null;
        $dialCode       = $countryObj->dial_code ?? $request->mobile_code ?? null;
